...
import { IconButton, Title, MD3Colors } from "react-native-paper";

interface Props {
  onPressYes: () => void;
  onPressNo: () => void;
}
const ExitAppModal = ({ onPressNo, onPressYes }: Props) => {
  return (
    <View style={styles.conatiner}>
      ...
      <View style={styles.buttonRow}>
        <View style={{ flex: 0.3 }}>
          <CustomButton label="Yes" onPress={onPressYes} mode="outlined" />
        </View>
        <View style={{ flex: 0.7 }}>
